...
function TabsList({
  ...
  return (
    <MotionHighlight
      controlledItems
      className={cn("rounded-lg bg-primary shadow-sm", activeClassName)}
      value={activeValue}
      transition={transition}
    >
      <div
  ...
  return (
    <MotionHighlightItem value={value} className="flex-1 flex items-center">
      <motion.button
        ...
        className={cn(
          "inline-flex cursor-pointer items-center justify-center whitespace-nowrap rounded-sm px-2 py-1 text-sm font-medium ring-offset-background transition-transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:text-foreground z-[1]",
          className
        )}
        {...props}
      >
